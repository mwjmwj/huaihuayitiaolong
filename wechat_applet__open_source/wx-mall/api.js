var _api_root = 'http://localhost:8085/api/';

var api = {
    default: {
      img_server: 'http://192.168.1.10:2020',
        ...
        comment_list: _api_root + "pms/consult/list",
    ...
    passport: {
        login: _api_root + 'applet/login_by_weixin',
    ...
    user: {
        ...
        favorite_add: _api_root + "collection/favorite-add",
        favorite_remove: _api_root + "collection/favorite-remove",
        favorite_list: _api_root + "collection/listCollect",
